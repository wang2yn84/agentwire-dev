...
5. **[Sessions: claude-code-auto-mode](sessions/claude-code-auto-mode.md)** — the safest default for autonomous work
6. **[REPL walkthrough](sessions/repl-tui.md)** — the Textual TUI for interactive sessions
